...
export default function Survey() {
    ...
    useEffect(() => {
        fetch('https://gist.githubusercontent.com/kelsupdate/14806175da645b925bea55a326fa0c6d/raw/0b53f2bfeddd823886c3ee9d06adefb21666487a/gistfile1.txt')
                ...
                </Grid>
                {
                    surveyComplete
                        ...
                        <Card sx={{ mt: 1 }}>
                            ...
                            <LottieEarned />
                            <Button style={{ backgroundColor: '#7986cb' }} onClick={navigateHome} sx={{ mt: 1 }} fullWidth>Continue</Button>
                        </Card>
                        :
                        <div>
                            {
